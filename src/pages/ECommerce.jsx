    ...
    <div className="mt-12">
      ...
      >
        ...
        h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat
         bg-cover bg-[center_left_6rem]"
        >
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold text-gray-400">Earnings</p>
              <p className="text-lg">Rp. 7.367.000,00</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
      ...
      >
        ...
        >
          <div id="Revenue Updates" className="flex justify-between">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-semibold">Rp.3.120.000</span>
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">Rp.1.875.000</span>
                </p>
